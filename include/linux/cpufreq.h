...
#elif defined(CONFIG_CPU_FREQ_DEFAULT_GOV_PEGASISQ)
extern struct cpufreq_governor cpufreq_gov_pegasisq;
#define CPUFREQ_DEFAULT_GOVERNOR	(&cpufreq_gov_pegasis2)
#endif
