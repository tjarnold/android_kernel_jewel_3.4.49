...
static struct msm_bus_paths bw_level_tbl[] __initdata = {
	...
	[8] = BW_MBPS(4532), /* At least 578 MHz on bus. */
};
...
static struct acpu_level acpu_freq_tbl_slow[] __initdata = {
	...
	{ 1, {   384000, HFPLL, 0, 0x00 }, L2(1),   950000 },
...
static struct acpu_level acpu_freq_tbl_nom[] __initdata = {
	{ 0, { STBY_KHZ,   QSB, 0, 0x00 }, L2(0),   800000 },
	{ 1, {   192000, PLL_8, 0, 0x00 }, L2(1),   800000 },
	{ 1, {   384000, HFPLL, 0, 0x00 }, L2(1),   900000 },
...
static struct acpu_level acpu_freq_tbl_fast[] __initdata = {
	{ 0, { STBY_KHZ,   QSB, 0, 0x00 }, L2(0),   800000 },
	{ 1, {   192000, PLL_8, 0, 0x00 }, L2(1),   800000 },
	{ 1, {   384000, HFPLL, 0, 0x00 }, L2(1),   850000 },
	...
	{ 1, {  1674000, HFPLL, 1, 0x3E }, L2(18), 1150000 },
	{ 0, { 0 } }
};
